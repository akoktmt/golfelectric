...
//
//    float N = WGS84_A / sqrtf(1 - WGS84_ECC_SQUARED * sinLat * sinLat);
//
//    *x = N * cosLat * cosLon;
//    *y = N * cosLat * sinLon;
//    *z = N * (1 - WGS84_ECC_SQUARED) * sinLat;
//}
...
//    gpsToEcef(latRef, lonRef, &xRef, &yRef, &zRef);
//
//    latRef = toRadians(latRef);
//    lonRef = toRadians(lonRef);
//
//    float dx = x - xRef;
//    float dy = y - yRef;
//    float dz = z - zRef;
//
//    float sinLat = sinf(latRef);
//    float cosLat = cosf(latRef);
//    float sinLon = sinf(lonRef);
//    float cosLon = cosf(lonRef);
//
